...
const NATURE = `A professional scientific concept illustration of the caliber of a top science magazine's feature graphic (Nature / Quanta style), on a CLEAN WHITE background (#ffffff). Sophisticated, polished, publication-grade editorial science visualization — refined FLAT VECTOR illustration with subtle depth and soft light shadows; absolutely NO dark background, NO glow, NO neon. A restrained, elegant palette: deep teal and slate-blue line-work and light fills, with a single warm amber/coral accent, all on white. Crisp and calm, rigorous information design, clear visual hierarchy, generous white space. Include clean, legible, correctly-spelled Chinese sans-serif LABELS exactly as specified (and the few English/technical tokens as written), set like real figure annotations. Extremely high craft, NOT cartoonish, NOT cluttered. IMPORTANT — do NOT add any journal name, logo, masthead, watermark, figure number, title bar, header band, or any extra caption/title text of your own; render ONLY the specific labels listed below, on a white background.`;

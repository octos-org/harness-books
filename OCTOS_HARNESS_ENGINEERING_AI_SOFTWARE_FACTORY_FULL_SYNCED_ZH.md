...
![注意力的软查找](./img/wf-attention-mixing.png)
...
![注意力稀释示意](./img/wf-softmax-dilution.png)

*图：注意力是一种守恒资源。横轴是窗口里的 token 数，纵轴是单个最锐目标能拿到的最大注意力权重 w_max；token 越多，同一份注意力被摊得越薄，w_max 沿曲线一路趋零——这就是“窗口越满、最锐检索越钝”的算术根源。*
...
![上下文窗口的非均匀分辨率](./img/wf-nonuniform-window.png)
...
![误差复合](./img/wf-error-compounding.png)
...
![容量上限与有效工作区间](./img/wf-capacity-window.png)
...
![recall–depth 的 U 形曲线](./img/wf-recall-ucurve.png)
...
![事实流折叠成多个投影](./img/wf-factstream-fold.png)
...
![可闭合：生成—验证—重试](./img/wf-closability-curve.png)

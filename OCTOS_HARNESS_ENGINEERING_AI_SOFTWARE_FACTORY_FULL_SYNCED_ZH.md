...
![注意力稀释示意](./img/softmax-dilution.jpg)

*图：注意力是一种守恒资源。上方窗口里 token 少，每束注意力又亮又锐；下方同一束注意力被摊到大片 token 上，落到每个远端目标的权重 \(w_{\max}\) 一路趋零——右侧那个暗金节点，正是被稀释到几乎看不见的“真正目标”。*
...
![上下文窗口的非均匀分辨率](./img/nonuniform-window.jpg)
...
![recall–depth 的 U 形曲线](./img/recall-depth-ucurve.jpg)
